...
var ball;
var slingShot;
var polygonBody,polygonSprite,polygon_img;
...
function setup(){
  ...
  polygonSprite=createSprite(100,200);
	polygonSprite.addImage(polygon_img);
	polygonSprite.scale=0.1;

  polygonBody = Bodies.circle(100,200,10);
  World.add(world, polygonBody);

  slingShot = new SlingShot(this.polygonBody,{x:140,y:100});
}
